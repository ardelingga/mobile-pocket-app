...
class DompetKeluarEdit extends StatefulWidget {
  // DompetTambah({Key? key}) : super(key: key);
  Function refreshPage;
  ItemTransaksiModel itemData;
  DompetKeluarEdit(this.itemData, this.refreshPage);

  @override
  _DompetKeluarEditState createState() => _DompetKeluarEditState();
}

class _DompetKeluarEditState extends State<DompetKeluarEdit> {
  ...
  Future<void> editDompetKeluar() async {
    ...
    if (kode.isNotEmpty &&
      ...
      showLoading();
      var req = await ApiService.editDompetKeluar(widget.itemData.idTransaksi.toString(), idGenerator.idGenerator, kode,
          deskripsi, tanggal, nilai, "2", dompet_id, kategori_id, status_id);

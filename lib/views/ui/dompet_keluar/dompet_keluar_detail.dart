...
class DompetKeluarDetail extends StatefulWidget {
  // DompetTambah({Key? key}) : super(key: key);
  Function refreshPage;
  ItemTransaksiModel itemData;
  DompetKeluarDetail(this.itemData, this.refreshPage);

  @override
  _DompetKeluarDetailState createState() => _DompetKeluarDetailState();
}

class _DompetKeluarDetailState extends State<DompetKeluarDetail> {

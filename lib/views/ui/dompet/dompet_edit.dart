...
class DompetEdit extends StatefulWidget {
  // DompetTambah({Key? key}) : super(key: key);
  ItemDompetModel data;
  Function refreshPage;
  DompetEdit(this.data, this.refreshPage);

  @override
  _DompetEditState createState() => _DompetEditState();
}

class _DompetEditState extends State<DompetEdit> {

...
class DompetTambah extends StatefulWidget {
  // DompetTambah({Key? key}) : super(key: key);
  Function refreshPage;
  DompetTambah(this.refreshPage);

  @override
  _DompetTambahState createState() => _DompetTambahState();
}

class _DompetTambahState extends State<DompetTambah> {
  ...
  Future<void> addDompet() async {
    ...
    showLoading();
    var req =
        await ApiService.addDompet(nama, referensi, deskripsi, valueStatus.id.toString());
